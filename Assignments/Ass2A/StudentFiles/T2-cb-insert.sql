...
Insert into BREEDING_EVENT (BREVENT_ID,BREVENT_DATE,MOTHER_ID,FATHER_ID) values ('1',TO_DATE('02-Apr-2020'),'5','12');
Insert into BREEDING_EVENT (BREVENT_ID,BREVENT_DATE,MOTHER_ID,FATHER_ID) values ('24',TO_DATE('07-Jan-2020'),'53','1');
Insert into BREEDING_EVENT (BREVENT_ID,BREVENT_DATE,MOTHER_ID,FATHER_ID) values ('7',TO_DATE('21-Jan-2021'),'5','64');
Insert into BREEDING_EVENT (BREVENT_ID,BREVENT_DATE,MOTHER_ID,FATHER_ID) values ('94',TO_DATE('17-Oct-2020'),'90','78');
Insert into BREEDING_EVENT (BREVENT_ID,BREVENT_DATE,MOTHER_ID,FATHER_ID) values ('67',TO_DATE('10-Dec-2020'),'18','20');
